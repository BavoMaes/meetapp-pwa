<template>
  <div class="chatinput">
    <input type="text" class="chatinput__input" placeholder="Type your message here..." />
    <svg class="chatinput__icon" xmlns="http://www.w3.org/2000/svg" width="512px" height="512px" viewBox="0 0 512 512">
      <path
